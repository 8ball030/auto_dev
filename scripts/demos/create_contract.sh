...
gum format """
We can generate a contract from 
any deployed verified contract.
...
"""
sleep $SLEEP_TIME
call_and_wait "adev scaffold contract author/usdc --address 0x833589fcd6edb6e08f4c7c32d4f71b54bda02913 --network base" 4
...
We now have extracted all;
 ...
 - write
 - events
We can see view the generated code 
in the local packages directory.
"""
sleep $SLEEP_TIME
